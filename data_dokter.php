					...
					<div class="row mt-3">
						<div class="col">
							...
							if(isset($_GET['cari'])){
								...
								$query=mysqli_query($conn,"SELECT * FROM dokter WHERE namadokter like '%$keyword%'");
							}else {
									$query = mysqli_query($conn,"SELECT * FROM dokter");
							}
							$no=1;
							...
							<tr>
								...
								<td><?php echo $ambil_data['namadokter'];?></td>
								<td><?php echo $ambil_data['alamatdokter'];?></td>
								<td><?php echo $ambil_data['no_hpdokter'];?></td>
								<td><a href="edit_dokter.php?id=<?php echo $ambil_data['iddokter']?>" class="btn btn-warning">Edit<a> ||  <a href="hapus_data_dokter.php?id=<?php echo $ambil_data['iddokter']?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus ini ?')">Hapus<a>
							</tr>
								<?php
								}
								?>
