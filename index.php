                ...
                <div class="col mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="data_peminjaman.php" class="btn btn-primary">Data Pemeriksaan</a>
                        </div>
                    </div>
                </div>
                <div class="col mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="data_pengembalian.php" class="btn btn-primary">Data Pasien</a>
                        </div>
                    </div>
                </div>
                <div class="col mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="data_buku.php" class="btn btn-primary">Data dokter</a>
                        </div>
                    </div>
                </div>
                    </div>
